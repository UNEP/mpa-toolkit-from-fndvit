<script lang="ts">
  ...
  import StickyMenu from "$lib/components/page/body/StickyMenu.svelte";
  import Block from "$lib/components/page/body/Block.svelte";
  import type { ContentDocument } from "@mpa/db";
  import { createSections } from "$lib/helpers/content";
  import Section from "$lib/components/page/body/Section.svelte";

  export let data;

  const sections = createSections(data.content);
